...
structural2=/project/bbl_projects/MotorGluCEST/structural/sandbox #path to processed structural data
cest=/project/bbl_projects/MotorGluCEST/glucest #path to processed GluCEST data
cest2=/project/bbl_projects/MotorGluCEST/glucest/sandbox #path to processed GluCEST data
...
do
case=$line
antsApplyTransforms -d 3 -r $structural/$case/$case-UNI-masked.nii.gz -i $motor_dir/MotorNetwork-Heatmap-50%.nii.gz -n NearestNeighbor -o $structural2/$case/atlases/${case}-MotorAtlas-50%Heatmap.nii.gz -t [$structural/$case/MNI_transforms/$case-UNIinMNI-0GenericAffine.mat,1] -t $structural/$case/MNI_transforms/$case-UNIinMNI-1InverseWarp.nii.gz
/project/bbl_projects/apps/melliott/scripts/extract_slice2.sh -MultiLabel $structural2/$case/atlases/${case}-MotorAtlas-50%Heatmap.nii.gz $cest/$case/orig_data/$case-B0B1CESTMAP.nii $cest2/$case/atlases/$case-2d-s100-MotorAtlas-50%Heatmap.nii
gzip $cest2/$case/atlases/$case-2d-s100-MotorAtlas-50%Heatmap.nii
done < /project/bbl_projects/MotorGluCEST/MotorGluCEST_Caselist_N47.txt
/p
