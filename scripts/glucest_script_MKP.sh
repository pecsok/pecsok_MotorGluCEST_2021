...
cest=/project/bbl_projects/MotorGluCEST/sandbox/glucest #path to processed GluCEST data
dicoms=/project/bbl_projects/MotorGluCEST/sandbox/dicoms #path to GUI Dicoms
#######################################################################################################
...
then
logfile=/project/bbl_projects/MotorGluCEST/sandbox/logs/cest/${case}.log
(
...
mv -f $cest/$case/*masktmp* $log_files/*masktmp*
#rm -f $cest/$case/*masktmp*
mv -f $cest/$case/*log* $log_files/*log*
#rm -f $cest/$case/*log*
...
/project/bbl_projects/apps/melliott/scripts/extract_slice2.sh -MultiLabel $structural/$case/atlases/${case}-RewardAtlas-TotalNetwork.nii.gz $cest/$case/orig_data/$case-B0B1CESTMAP.nii $cest/$case/atlases/$case-2d-RewardAtlas-TotalNetwork.nii
...
/project/bbl_projects/apps/melliott/scripts/extract_slice2.sh -MultiLabel $structural/$case/atlases/${case}-RewardAtlas-posandneg-3C.nii.gz $cest/$case/orig_data/$case-B0B1CESTMAP.nii $cest/$case/atlases/${case}-2d-RewardAtlas-posandneg-3C.nii
...
/project/bbl_projects/apps/melliott/scripts/extract_slice2.sh -MultiLabel $structural/$case/atlases/${case}-RewardAtlas-positive-3A.nii.gz $cest/$case/orig_data/$case-B0B1CESTMAP.nii $cest/$case/atlases/$case-2d-RewardAtlas-positive-3A.nii
...
mv -f  $cest/$case/atlases/$case-2d-RewardAtlas-positive-3A.nii.gz $log_files/$case-2d-RewardAtlas-positive-3A.nii.gz
...
/project/bbl_projects/apps/melliott/scripts/extract_slice2.sh -MultiLabel $structural/$case/atlases/${case}-RewardAtlas-negative-3B.nii.gz $cest/$case/orig_data/$case-B0B1CESTMAP.nii $cest/$case/atlases/$case-2d-RewardAtlas-negative-3B.nii
